...
export function getPackageDir(): string {
	...
	const envDir = process.env.PO_PACKAGE_DIR;
	if (envDir) {
...
export const APP_NAME: string = pkg.piConfig?.name || "po";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".po";
export const VERSION: string = pkg.version;

// e.g., PO_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.PO_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.po/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.po/agent/) */
