...
/**
 * Migrate sessions from ~/.po/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.po/agent/ instead of
 * ~/.po/agent/sessions/<encoded-cwd>/. This migration moves them
 ...
 * Note: tools/ may contain fd/rg binaries extracted by po, so only warn if it has other files.
 */
