...
function getTempFilePath(): string {
	...
	return join(tmpdir(), `po-bash-${id}.log`);
}
...
/**
 * Create bash operations using po's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want po's
